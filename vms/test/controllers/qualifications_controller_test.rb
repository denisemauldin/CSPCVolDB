...
class QualificationsControllerTest < ActionController::TestCase
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post :create, qualification: { count: @qualification.count, position_id: @qualification.position_id, status: @qualification.status, user_id: @qualification.user_id }
    end
  ...
  test "should update qualification" do
    patch :update, id: @qualification, qualification: { count: @qualification.count, position_id: @qualification.position_id, status: @qualification.status, user_id: @qualification.user_id }
    assert_redirected_to qualification_path(assigns(:qualification))
  end
